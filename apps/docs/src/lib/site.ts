...
export const SITE = {
  ...
  description:
    "Word-sized charts for React. Zero runtime dependencies, 0.9–3.7 kB gzip each, accessible by default, and server-component safe. Sparklines, bars, deltas, bullets, and activity grids that read at a glance.",
