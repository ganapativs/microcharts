...
export const metadata = docsMeta({
  title: "Elements",
  description:
    "Word-sized charts for React, made for AI and the people reading what it writes. Zero dependencies, accessible by default, server-rendered.",
  path: "/elements",
  noindex: true,
});
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 pb-14 pt-16 sm:px-6 sm:pb-16 sm:pt-18 lg:grid-cols-[1.06fr_0.94fr] lg:gap-14">
          <div>
            ...
            <Reveal delay={60}>
              <h1 className="display mt-5 text-balance text-[2.3rem] leading-[1.05] text-fd-foreground sm:text-[3rem] lg:text-[3.65rem] xl:text-[4.15rem]">
