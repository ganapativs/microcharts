...
is the smallest supported size.

Colors
------
Cobalt (accent), light   #2f52d4
Cobalt (accent), dark    #7f9cf5
...
least one cell-width on every side. Don't recolor the cells, rotate,
stretch, add effects, or imply endorsement. The name is one lowercase
word: "microcharts". Package: @microcharts/react.

Code is MIT. https://microcharts.dev/brand
