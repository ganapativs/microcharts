...
need them. The two entries never mix, so you pay for interactivity only where you ask for it, and a static chart can't
drag a listener into your server bundle.
