...
The `/interactive` subpath lands between **2.18 kB and 7 kB** gzip, with a **median of 5.25 kB**. That buys hover,
roving keyboard focus, select-to-pin, touch scrub, and live announcements. Its static twin is pure SVG with zero client
JavaScript, and lands between **1.08 kB and 4.25 kB**, with a **median of 2.75 kB**. A page pays for interactivity only
