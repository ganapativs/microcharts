...
The interactive catalog lands between **2.03 kB and 6.67 kB** gzip, with a **median of 5.04 kB** — hover, roving
keyboard focus, select-to-pin, touch scrub, and live announcements from the `/interactive` subpath. The static twin
lands between **0.98 kB and 4.01 kB**, with a **median of 2.6 kB** — pure SVG, zero client JavaScript. A page pays for
...
Twenty-five charts sit above the 3 kB static reference line, none of them by more than 1.01 kB. Sparkline, the most
