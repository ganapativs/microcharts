...
title: Performance
description:
  Zero dependencies, budget-gated sizes, and server rendering with no client JavaScript — 106 chart types at ~1–4 kB
  gzip each, rendered to SVG at about 0.031 ms each. Every number here is reproducible from one command.
---
...
The whole catalog lands between **0.97 kB and 3.93 kB** gzip, with a **median of 2.51 kB** — and that's the _static_
