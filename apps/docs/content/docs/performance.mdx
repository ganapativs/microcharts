...
The `/interactive` subpath lands between **2.27 kB and 7 kB** gzip, with a **median of 5.3 kB**. That buys hover, roving
keyboard focus, select-to-pin (and light dismiss), touch scrub, and live announcements. Its static twin is pure SVG with
zero client JavaScript, and lands between **1.08 kB and 4.25 kB**, with a **median of 2.78 kB**. A page pays for
