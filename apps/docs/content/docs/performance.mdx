...
The interactive catalog lands between **1.86 kB and 6.49 kB** gzip, with a **median of 4.88 kB** — hover, roving
keyboard focus, select-to-pin, touch scrub, and live announcements from the `/interactive` subpath. The static twin
lands between **0.97 kB and 3.96 kB**, with a **median of 2.58 kB** — pure SVG, zero client JavaScript. A page pays for
...
Twenty-two charts sit above the 3 kB static reference line, none of them by more than 0.96 kB. Sparkline, the most
