...
The `/interactive` subpath lands between **2.29 kB and 6.99 kB** gzip, with a **median of 5.33 kB**. That buys hover,
roving keyboard focus, select-to-pin (and light dismiss), touch scrub, and live announcements. Its static twin is pure
SVG with zero client JavaScript, and lands between **1.08 kB and 4.26 kB**, with a **median of 2.79 kB**. A page pays
