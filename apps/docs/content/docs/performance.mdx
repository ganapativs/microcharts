...
The interactive catalog lands between **2.17 kB and 6.75 kB** gzip, with a **median of 5.07 kB** — hover, roving
keyboard focus, select-to-pin, touch scrub, and live announcements from the `/interactive` subpath. The static twin
lands between **1 kB and 4.07 kB**, with a **median of 2.64 kB** — pure SVG, zero client JavaScript. A page pays for
...
Twenty-seven charts sit above the 3 kB static reference line, none of them by more than 1.07 kB. Sparkline, the most
