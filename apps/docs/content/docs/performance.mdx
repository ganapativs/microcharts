...
The `/interactive` subpath lands between **2.28 kB and 6.97 kB** gzip, with a **median of 5.31 kB**. That buys hover,
roving keyboard focus, select-to-pin (and light dismiss), touch scrub, and live announcements. Its static twin is pure
SVG with zero client JavaScript, and lands between **1.08 kB and 4.26 kB**, with a **median of 2.8 kB**. A page pays for
interactivity only where it uses it. About 0.5 kB of the interactive delta is the shared picker kernel, which the
