...
The `/interactive` subpath lands between **2.18 kB and 6.99 kB** gzip, with a **median of 5.32 kB**. That buys hover,
roving keyboard focus, select-to-pin (and light dismiss), touch scrub, and live announcements. Its static twin is pure
SVG with zero client JavaScript, and lands between **1.08 kB and 4.25 kB**, with a **median of 2.76 kB**. A page pays
