...
Every preset also answers to `data-mc-preset`, the page-global form — set it once on `<html>` for an app shell, and a
nearer `data-mc-theme` still wins by proximity.
