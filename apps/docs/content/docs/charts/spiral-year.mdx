...
title: SpiralYear
description: >-
  React spiral year chart — a full year of values wound as a spiral by day or week. Tiny accessible SVG microchart;
...
The accessible name states the count, the peak, and the low — **"52 weeks; peak 480 in week 30, low in week 48."** The
interactive entry lets you arrow along the spiral chronologically, each mark announced with its period and value through
a polite live region. Because the channel is ordinal opacity, the docs and summary steer any exact read to
`ActivityGrid`.
