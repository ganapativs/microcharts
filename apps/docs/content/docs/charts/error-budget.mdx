...
title: ErrorBudget
description: >-
  React error-budget chart — SLO budget remaining against the steady-burn diagonal and burn-rate lines. Tiny accessible
  SVG microchart; RSC-safe static or /interactive.
---
