...
title: MicroBox
description:
  A box plot in a table row for React — median, IQR, and honest whiskers, with the violin's documented replacement role.
---
...
side (the furthest); the clipped count rides the announcements.
