...
title: BreathingDot
description: >-
  React breathing dot chart — ambient load as pulse rate, with a static reduced-motion twin. Tiny accessible SVG
...
The accessible name is the level and its band word — **"Load 42% — calm."** — or **"Load unknown."** when the value is
