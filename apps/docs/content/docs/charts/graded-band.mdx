...
The accessible name states the median and the innermost + outermost intervals — for example, **"Median 50; 50% within
25–75, 95% within 2.5–97.5."** The interactive entry roves the band edges and announces each interval's coverage and
bounds.
