...
title: DepthWedge
description:
  An order-book depth glyph for React — two cumulative step-wedges meeting at the spread, showing supply vs demand
  posture on a linear scale.
---
...
would exaggerate near-spread depth and flatter thin books. The visible range is part of the claim, so the summary always
carries "within the shown range", and the spread — the gap between the best bid and best ask — is the headline number
above the mid line.
