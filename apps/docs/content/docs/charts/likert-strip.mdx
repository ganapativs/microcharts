...
5 points reads "Balanced." The interactive entry steps levels in data order, carrying the response count beside the
share it was computed from (**"Disagree: 14% (14), level 2 of 5."**).
