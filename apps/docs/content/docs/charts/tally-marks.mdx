...
title: TallyMarks
description: >-
  React tally marks chart — counts as five-and-strike tally clusters humans already read. Tiny accessible SVG
...
<LiveDemo
  label="negative clamps to 0 — the summary reads '0 counted.', never a negative count"
...
The accessible name is the exact count — **"23 counted."** — always the true value, even when the marks overflow to a
...
<InteractionNote slug="tally-marks" />
