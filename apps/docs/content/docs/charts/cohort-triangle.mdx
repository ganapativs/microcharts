...
description:
  A cohort-retention heatmap for React — vintages as rows, age as columns, shaded by discrete retention levels, so the
  worst-decaying cohort reads at equal maturity.
---
