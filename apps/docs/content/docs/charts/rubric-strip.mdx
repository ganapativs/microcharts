...
title: RubricStrip
description:
  A weighted scorecard for React — bar length is the score, bar thickness is the criterion's weight, and there is
  deliberately no composite total.
---
...
The accessible name names the extremes — **"4 criteria; highest Correctness (0.92), lowest Style (0.41)."** The
