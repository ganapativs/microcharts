...
title: Waveform
description:
  An amplitude strip for React — the shape of a high-frequency signal at word width, compressed by max-per-bucket so a
  spike can never be averaged away.
---
...
The accessible name discloses the peak — **"Peak 0.738 at 63% through 200 samples."** Pure silence reads **"Silent."**
