...
title: WinProbWorm
description:
  A win-probability worm for React — a single 0–100 probability on a fixed, never-truncated axis, split at the 50% line
  so leading stretches read accent and trailing stretches read neutral, with a dot at every lead change.
---
...
>
  <span className="inline-flex gap-4 items-center">
    <WinProbWorm data={[50, 58, 66, 74, 80, 86, 90, 93, 96, 98, 99]} sides={["home", "away"]} width={160} height={24} />
    <WinProbWorm
...
<InteractionNote slug="win-prob-worm" />
