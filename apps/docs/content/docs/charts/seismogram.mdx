...
title: Seismogram
description: >-
  React seismogram chart — high-frequency amplitude trace at word width. Tiny accessible SVG microchart; RSC-safe static
  or /interactive.
---
...
interactive entry steps slots with position readouts ("Point 2 of 5: 3."). A quiet slot reads as the zero it is ("Point
1 of 5: 0.") — only a missing sample announces "no data" — and Home/End jump to the first/last event.
