...
title: Waterfall
description:
  A word-sized waterfall chart for React — signed deltas composing into a total, with a zero-anchored total bar keeping
  the bridge honest.
---
...
<Waterfall data={steps} start={60} totalBar={false} />`}
>
