...
title: CometTrail
description: >-
  React comet trail chart — a path with a fading trail of recent positions. Tiny accessible SVG microchart; RSC-safe
...
The accessible name is the now-value and the recent trend — **"Now 87, rising over the last 12 updates."** — or just the
