...
title: ControlStrip
description:
  A Shewhart control chart for React — points against a ±3σ̂ control band with only out-of-control excursions marked,
  plus optional Western Electric run rules.
---
