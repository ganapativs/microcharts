...
title: Dumbbell
description:
  A dumbbell chart for React — where each row started and ended, hollow-to-filled direction with no legend needed.
---
...
Single row: **"From 62,000 to 84,000, up 35%."**; a degenerate pair says **"No change at 62,000."**; multi-row leads
with the largest change (**"2 rows. Largest change Berlin, up 42%."**). The interactive entry roves rows with ↑/↓ and
inspects either end with ←/→ ("From: 48." / "To: 68.").
