...
Single row: **"From 62,000 to 84,000, up 35%."**; a degenerate pair says **"No change at 55."**; multi-row leads with
the largest change (**"2 rows. Largest change Paris, up 17%."**). The interactive entry roves rows with ↑/↓ (←/→ do the
