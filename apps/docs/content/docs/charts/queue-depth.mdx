...
title: QueueDepth
description:
  A backlog-depth microchart for React — a zero-anchored stock area against a capacity hairline, with above-capacity
  spans re-stroked in the negative ink and a last-quarter trend glyph.
---
...
>
  <QueueDepth data={[42, 55, 70, 88, 96, 120, 150, 182, 214]} title="No capacity" width={220} height={28} />
</LiveDemo>

<LiveDemo label="draining below capacity" code={`<QueueDepth data={[90, 70, 50, 30]} capacity={100} />`}>
...
>
  <QueueDepth data={[10, null, 40, null, 80, 120]} capacity={100} title="Gaps" width={220} height={28} />
</LiveDemo>
...
<InteractionNote slug="queue-depth" />
