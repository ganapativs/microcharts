...
the domains are linear, and the framing is disclosed. The tail, endpoint, and arrowhead trio may be restyled but never
all removed, because the recoverable time direction is what separates a phase trace from a scatter.
