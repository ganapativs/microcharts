...
title: Hourglass
description: >-
  React hourglass chart — sand area that splits elapsed and remaining, area-true. Tiny accessible SVG microchart;
...
The accessible name carries both sides — the third glyph above reads **"85% elapsed, 15% remaining."** The interactive
entry cross-fades the sand levels on change (opacity plus a scale-from-the-floor settle, never a path interpolation) and
