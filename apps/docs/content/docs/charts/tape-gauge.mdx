...
title: TapeGauge
description:
  A moving-scale micro instrument for React — the level now, the zone it's in, and how fast it's moving, with the eye
  parked in one place. Position encodes level, chevrons encode rate, and the two never blend.
---
