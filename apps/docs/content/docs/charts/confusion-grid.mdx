...
announcing each cell's actual and predicted class as a share of the actual class, with the tally it was computed from
(**"Actual cat, predicted dog: 12% of cats (12)."**) — a row percentage cannot be inverted back to a count without the
row total.
