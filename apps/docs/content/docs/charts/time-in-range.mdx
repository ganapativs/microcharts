...
title: TimeInRange
description:
  A time-in-band strip for React — how much of a period stayed inside its corridor, in a fixed semantic zone order, with
  the in-range percent as the headline.
---
