...
title: TimeInRange
description: >-
  React time-in-range chart — how much of a period stayed inside its corridor, with in-range percent as the headline.
  Tiny accessible SVG microchart; RSC-safe static or /interactive.
---
