...
No install needed to feel it out. This is a full Vite + React app with the package installed, running in your browser —
static and interactive charts, inline and block, four themes. Run it here, or open it in StackBlitz to edit.
