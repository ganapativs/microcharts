...
title: Introduction
description:
  Word-sized charts for React, made for LLMs and humans — zero dependencies, ~1–4 kB gzip each, accessible by default,
...
- **Tiny.** Static charts are **~1–4 kB gzip** each, imported from their own subpath and budget-gated in CI.
