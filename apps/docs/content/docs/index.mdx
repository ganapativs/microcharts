...
title: Introduction
description:
  Word-sized charts for React, made for LLMs and humans — zero dependencies, 1–3.9 kB gzip each, accessible by default,
...
- **Tiny.** Static charts span **1–3.9 kB gzip** (median 2.5), each imported from its own subpath and budget-gated in
  CI.
