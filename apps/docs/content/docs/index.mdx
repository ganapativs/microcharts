...
title: Introduction
description:
  Word-sized charts for React, made for LLMs and humans — zero dependencies, ~2–7 kB interactive · ~1–4 kB static,
  accessible by default, and server-component safe. 106 chart types, one grammar.
---
