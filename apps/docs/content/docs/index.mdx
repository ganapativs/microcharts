...
title: Introduction
description:
  Word-sized charts for React, made for LLMs and humans — zero dependencies, 1–3.7 kB gzip each, accessible by default,
  and server-component safe. 106 chart types, one grammar.
---
...
- **Tiny.** Static charts span **1–3.7 kB gzip** (median 2.3), each imported from its own subpath and budget-gated in
  CI.
