...
title: Introduction
description:
  Word-sized charts for React, made for LLMs and humans — zero dependencies, 0.9–3.7 kB gzip each, accessible by
...
- **Tiny.** Static charts span **0.9–3.7 kB gzip** (median 2.3), each imported from its own subpath and budget-gated in
  CI.
