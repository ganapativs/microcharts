...
**Budgets (measured reality, plan/07 §amended + plan/21 §1):** static ≤ 3 kB gz per subpath (Delta-class simple charts ≤ 1.5 kB), interactive ≤ static + 1 kB, shared kernel ≤ 5 kB, styles.css ≤ 12 kB shared (raised from 10 kB for the 100-type catalog, 2026-07-08). SSR bench floor: ≥ ~50 rows/ms.
