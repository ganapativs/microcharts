// SpiralYear summary templates (spiral-year). A calendar series wound onto a spiral; the
// summary names the count, the peak, and the low. Opacity is a LOW-precision ordinal
// channel, so this is a pattern instrument and the docs steer point reads to
// ActivityGrid/HeatStrip.
